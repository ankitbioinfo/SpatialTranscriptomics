...
#SHAPE = {Axes.Y: 1563, Axes.X: 1065}
SHAPE = {Axes.Y: 1648, Axes.X: 1082}
...
class ISSPrimaryTileFetcher(TileFetcher):
    def __init__(self, input_dir):
        ...
        #coordinates = os.path.join(input_dir,"coordinates.json")
    @property
    def ch_dict(self):
    ...
    def round_dict(self):
        ...
        round_str = ['C4_H1P4','C6_H2P9','C1_H3P4','C5_H3P5','C2_H3P9','C3_H3P11']
...
def format_data(input_dir, output_dir, d):
    ...
    write_experiment_json(
        ...
        aux_tile_fetcher={
            'nuclei': ISSAuxTileFetcher(os.path.join(input_dir, "segmented_Image", "MAX_C1_H3P4_H3P9_H3P11_nuclei_channel.tif")),
            'dots': ISSAuxTileFetcher(os.path.join(input_dir, "segmented_Image", "MAX_H3P4_H3P9_H3P11_feature_0_good.tif")),
        },
