...
def main():
    ...
    author_interest_all=[['c16'],['c14','c1'],['c9','c4'],['c13'],['c9'],
                ['c0','c1','c2','c3',   'c5'],['c1','c3'],['c14'],
                ['c1','c12','c7'],
                ['c17','c4'],['c9'],['c7','c1'],['c1','c9'],['c1','c2','c7'],['c1','c14'],
                ['c1','c14'],['c10'],['c14','c1'],
                ['c1','c9'],['c7','c1','c2'],['c9','c7','c1'],
                ['c10','c18','c9','c11','c12','c6','c15']]
    ...
    #for i in [21]:
        ...
        #region=[3500,6000,2000,5000] #xmin xmax ymin max
        #region=[3500,6000,5000,8000]
        region=[6000,8000,3000,7000]

        ax1[0].set_xlim([region[0],region[1]])
        ax1[0].set_ylim([region[2],region[3]])
        ax0[0].set_xlim([region[0],region[1]])
        ax0[0].set_ylim([region[2],region[3]])
        ax2[0].set_xlim([region[0],region[1]])
        ax2[0].set_ylim([region[2],region[3]])
