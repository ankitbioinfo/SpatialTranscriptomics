...
class ISSPrimaryTileFetcher(TileFetcher):
    ...
    def ch_dict(self):
        ...
        ch_dict = {0:'C3-1',1:'C4-1',2:'C1-1',3:'C2-1'}
        return ch_dict

    @property
    def round_dict(self):
        round_str = ['1st', '2nd', '3rd', '4th','5th','6th']
        #round_str = ['1st', '2nd']
...
def format_data(input_dir, output_dir, d):
    ...
    write_experiment_json(
        ...
        aux_tile_fetcher={
            'nuclei': ISSAuxTileFetcher(os.path.join(input_dir, "segmented_Image", "segment.tif")),
            'dots': ISSAuxTileFetcher(os.path.join(input_dir, "segmented_Image", "1_1st_C1.tif")),
        },
